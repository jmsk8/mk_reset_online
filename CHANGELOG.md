...
- **Page 503 explicite** : un refus pour excès de débit renvoie désormais une page lisible portant un en-tête `Retry-After`, au lieu de l'erreur brute du serveur qui laissait croire à une panne et invitait à rafraîchir — ce qui ne faisait qu'aggraver la situation
